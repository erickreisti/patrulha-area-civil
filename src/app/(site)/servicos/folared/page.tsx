          ...
          >
            ...
            >
              <Badge className="mb-4 sm:mb-6 bg-white/20 backdrop-blur-sm border-white/20 text-white hover:bg-white/30 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium">
                <RiGlobalLine className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
            ...
            >
              ...
              <span className="font-semibold text-white">União</span>,{" "}
              <span className="font-semibold text-white">cooperação</span> e{" "}
              <span className="font-semibold text-white">aperfeiçoamento</span>{" "}
              regional.
            </motion.p>
          </motion.div>
        </div>
                ...
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-500">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                      ...
                      da América Latina - FOLARED (Federação de Organismos
                      Latino Americanos de Resposta a Emergências e Desastres).
                    </p>
                    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                    ...
                    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                      Nos orgulhamos em trocar experiências com nossos irmãos
                      das áreas de resgates, buscando sempre o aperfeiçoamento
                      para melhor servir às comunidades.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
                    ...
                    >
                      {beneficios.map((beneficio, index) => (
                        <motion.div
                          ...
                          className="flex items-start space-x-3 p-4 sm:p-5 bg-gradient-to-r from-gray-50 to-white rounded-xl border border-gray-200 hover:border-navy-200 transition-all duration-300 group"
                        >
              ...
              >
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-500">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    >
                      <RiTeamLine className="h-5 w-5 text-navy-600" />
                      <div>
                    ...
                    <motion.div
                      ...
                      className="flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-all duration-200"
                    >
                      <RiMedalLine className="h-5 w-5 text-navy-600" />
                      <div>
                        <p className="font-semibold text-gray-800 text-sm">
                          Capacitação
                        </p>
                    ...
                    <motion.div
                      ...
                      className="flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-all duration-200"
                    >
                      <RiShieldCheckLine className="h-5 w-5 text-navy-600" />
                      <div>
                        <p className="font-semibold text-gray-800 text-sm">
                          Padronização
                        </p>
          ...
          >
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 font-bebas tracking-wide">
                UNIDOS POR UMA AMÉRICA LATINA MAIS SEGURA
              </h2>
              <p className="text-lg mb-6 text-blue-100 max-w-2xl mx-auto leading-relaxed">
                A FOLARED representa a união das melhores organizações de
                resgate da América Latina. Juntos, compartilhamos conhecimento,
                tecnologia e experiência para servir melhor nossas comunidades.
              </p>
            </motion.div>
              ...
              >
                ...
                >
                  <Link
                    ...
                    className="flex items-center justify-center"
                  >
                    <RiBookOpenLine className="mr-2 w-4 h-4 sm:w-5 sm:h-5" />
                    Conhecer a PAC
                  </Link>
                </Button>
              </motion.div>
