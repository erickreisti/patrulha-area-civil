...
const estatisticas = [
  {
    numero: "Diuturno",
    label: "Atendimento Leito a Leito",
    icon: RiHeartLine,
    delay: 0,
  },
  {
          ...
          >
            ...
            >
              <Badge className="mb-4 sm:mb-6 bg-white/20 backdrop-blur-sm border-white/20 text-white hover:bg-white/30 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium">
                <RiHeartLine className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
            ...
            >
              ...
              familiares.{" "}
              <span className="font-semibold text-white">Compaixão</span>,{" "}
              <span className="font-semibold text-white">acolhimento</span> e{" "}
              <span className="font-semibold text-white">esperança</span> em
                ...
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-500">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                      A Capelania é a assistência religiosa prestada por
                      Ministro religioso garantido por lei em entidades civis e
                      militares de internação coletiva, conforme dispositivo
                      previsto na Constituição Brasileira de 1988.
                    </p>
                    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                      É uma atividade cuja missão é colaborar na formação
                      integral do ser humano, oferecendo oportunidades de
                      conhecimento, reflexão, desenvolvimento e aplicação dos
                      valores e princípios ético-cristãos.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
                    ...
                    >
                      {servicos.map((servico, index) => (
                        <motion.div
                          ...
                          className="flex items-start space-x-3 p-3 sm:p-4 bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-200 hover:border-navy-200 transition-all duration-300"
                        >
                          <div className="bg-gradient-to-br from-navy-600 to-blue-600 rounded-lg w-8 h-8 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    {apoioEspiritual.map((apoio, index) => (
                      ...
                      >
                        <div className="bg-gradient-to-br from-navy-600 to-blue-600 rounded-lg w-10 h-10 flex items-center justify-center flex-shrink-0">
                          <apoio.icon className="w-5 h-5 text-white" />
                        </div>
                        <div>
          ...
          >
            ...
            >
              <div className="bg-gradient-to-br from-navy-600 to-blue-700 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-lg">
                <RiHeartLine className="w-8 h-8 text-white" />
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 font-bebas tracking-wide">
                CUIDADO INTEGRAL PARA O SER HUMANO
              </h2>
              <p className="text-lg mb-6 text-blue-100 max-w-2xl mx-auto leading-relaxed">
                A Capelania vai além da assistência religiosa. Oferecemos apoio
                espiritual, psicológico e emocional para pacientes e familiares,
                promovendo a dignidade humana em momentos de vulnerabilidade.
              </p>
            </motion.div>
