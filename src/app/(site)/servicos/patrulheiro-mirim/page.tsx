...
const atividades = [
  {
    icon: RiFlagLine,
    title: "Atendimento educativo e disciplinar",
  },
  {
    icon: RiBookOpenLine,
    title: "Apoio pedagógico e psicológico",
  },
  {
    icon: RiUserStarLine,
    title: "Suporte sócio familiar",
  },
  {
    icon: RiHeartLine,
    title: "Despertar patriotismo e dever cívico",
  },
  {
    icon: RiShieldCheckLine,
    title: "Ensino de hierarquia e disciplina",
  },
  {
    icon: RiLeafLine,
  ...
  },
  {
    ...
    title: "Práticas de sustentabilidade",
  },
  {
    icon: RiMedalLine,
          ...
          >
            ...
            >
              <Badge className="mb-4 sm:mb-6 bg-white/20 backdrop-blur-sm border-white/20 text-white hover:bg-white/30 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium">
                <RiTeamLine className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                Projeto Social
              </Badge>
            </motion.div>
            ...
            >
              ...
              <span className="font-semibold text-white">Educação</span>,{" "}
              <span className="font-semibold text-white">disciplina</span> e{" "}
              <span className="font-semibold text-white">cidadania</span> para
                    ...
                    >
                      {atividades.map((atividade, index) => (
                        <motion.div
                          ...
                          className="flex items-center space-x-3 p-3 sm:p-4 bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-200 hover:border-navy-200 transition-all duration-300"
                        >
                ...
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-500">
                  ...
                  <CardContent className="space-y-3">
                    {parceiros.map((parceiro, index) => (
                      ...
                      >
                        <div className="w-2 h-2 bg-gradient-to-br from-navy-600 to-blue-600 rounded-full flex-shrink-0"></div>
          ...
          >
            ...
            >
              ...
              <p className="text-lg mb-6 text-blue-100 max-w-2xl mx-auto leading-relaxed">
                O Patrulheiro Mirim é mais que um projeto, é uma oportunidade de
                transformação. Junte-se a nós na missão de construir um futuro
                melhor para nossa juventude.
              </p>
            </motion.div>
