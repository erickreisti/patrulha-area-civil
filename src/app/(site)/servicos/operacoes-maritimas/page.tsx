...
const operacoes = [
  {
    icon: RiShip2Line,
    title: "Incêndios em Embarcações",
  },
  {
    icon: RiWaterFlashLine,
    title: "Acidentes com Naufrágios",
  },
  {
    icon: RiLifebuoyLine,
    title: "Afogamentos e Resgate Aquático",
  },
  {
    icon: RiAnchorLine,
    title: "Busca e Resgate Subaquáticos",
  },
  {
    icon: RiShieldCheckLine,
    title: "Recuperação de Objetos Submersos",
  },
  {
    icon: RiSparklingLine,
    title: "Desobstrução Submarina",
  },
  {
    icon: RiTeamLine,
    title: "Operações de Mergulho",
  },
  {
    icon: RiMedalLine,
...
const estatisticas = [
  ...
  {
    numero: "24/7",
    label: "Monitoramento Marítimo",
    icon: RiGlobalLine,
    delay: 1,
  },
  {
    numero: "12+",
    label: "Mergulhadores Especializados",
    icon: RiTeamLine,
    delay: 2,
  },
  {
          ...
          >
            ...
            >
              <Badge className="mb-4 sm:mb-6 bg-white/20 backdrop-blur-sm border-white/20 text-white hover:bg-white/30 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium">
                <RiShipLine className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                Grupamento Marítimo
              </Badge>
            </motion.div>
            ...
            >
              ...
              <span className="font-semibold text-white">eficiência</span> e{" "}
              <span className="font-semibold text-white">precisão</span> em cada
              operação naval.
            </motion.p>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-500">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                      O Grupamento Marítimo tem como missão operar em situações
                      de Busca, Resgate e Salvamento em ambientes líquidos,
                      possuindo em seu quadro especialistas em operações navais
                      e de mergulho.
                    </p>
                    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                      Nossa equipe está preparada para atuar em diversas
                      situações marítimas, desde emergências em embarcações até
                      operações de resgate subaquático.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
                    ...
                    >
                      {operacoes.map((operacao, index) => (
                        <motion.div
                          ...
                          className="flex items-center space-x-3 p-4 sm:p-5 bg-gradient-to-r from-gray-50 to-white rounded-xl border border-gray-200 hover:border-blue-200 transition-all duration-300 group"
                        >
                          <div className="bg-gradient-to-br from-navy-600 to-blue-600 rounded-lg w-10 h-10 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                            <operacao.icon className="w-5 h-5 text-white" />
                          </div>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              >
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-500">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    >
                      <RiShip2Line className="h-5 w-5 text-navy-600" />
                      <div>
                        <p className="font-semibold text-gray-800 text-sm">
                          Operações Navais
                        </p>
                        <p className="text-gray-600 text-xs">
                          Emergências em embarcações
                        </p>
                      </div>
                    </motion.div>
                    <motion.div
                      ...
                      className="flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-all duration-200"
                    >
                      <RiAnchorLine className="h-5 w-5 text-navy-600" />
                      <div>
                        <p className="font-semibold text-gray-800 text-sm">
                          Mergulho de Resgate
                        </p>
                        <p className="text-gray-600 text-xs">
                          Resgate e recuperação subaquática
                        </p>
                      </div>
                    </motion.div>
                    <motion.div
                      ...
                      className="flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-all duration-200"
                    >
                      <RiLifebuoyLine className="h-5 w-5 text-navy-600" />
                      <div>
                        <p className="font-semibold text-gray-800 text-sm">
                          Resgate Aquático
                        </p>
                        <p className="text-gray-600 text-xs">
                          Afogamentos e emergências
                        </p>
                      </div>
                    </motion.div>
                  </CardContent>
              ...
              >
                <Card className="border border-navy-200 bg-gradient-to-br from-navy-50 to-blue-50 shadow-lg hover:shadow-xl transition-all duration-500">
                  <CardHeader className="pb-3 pt-6">
                    <CardTitle className="text-navy-600 text-lg sm:text-xl font-bebas tracking-wide">
                      EMERGÊNCIA MARÍTIMA?
                    </CardTitle>
                  ...
                  <CardContent>
                    <Button
                      asChild
                      className="w-full bg-gradient-to-r from-navy-600 to-blue-600 hover:from-navy-700 hover:to-blue-700 text-white font-semibold transition-all duration-300 hover:shadow-lg shadow-md py-3"
                    >
                      <Link
                        href="/contato"
          ...
          >
            ...
            >
              <div className="bg-gradient-to-br from-navy-600 to-blue-700 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-lg">
                <RiShipLine className="w-8 h-8 text-white" />
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 font-bebas tracking-wide">
                SEGURANÇA EM TODO LITORAL
              </h2>
              <p className="text-lg mb-6 text-blue-100 max-w-2xl mx-auto leading-relaxed">
                Nossa frota está equipada com tecnologia de ponta e nossa equipe
                treinada para atuar em qualquer condição marítima. A segurança
                das águas é nossa prioridade.
              </p>
            </motion.div>
