...
const areasAtuacao = [
  {
    ...
    description: "Combate em ambientes naturais e urbanos",
  },
  {
    icon: RiRoadMapLine,
          ...
          >
            ...
            >
              <Badge className="mb-4 sm:mb-6 bg-white/20 backdrop-blur-sm border-white/20 text-white hover:bg-white/30 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium">
                <RiMapPinLine className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
            ...
            >
              ...
              terrestres diversos.{" "}
              <span className="font-semibold text-white">Precisão</span>,{" "}
              <span className="font-semibold text-white">agilidade</span> e{" "}
              <span className="font-semibold text-white">segurança</span> em
              cada operação.
            </motion.p>
          </motion.div>
        </div>
              ...
              >
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-500">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                      Atuamos em incêndios em florestas e outros ambientes
                      rurais e urbanos, operações de resgate em áreas de
                      difíceis acessos e operações de resgate em área restritas
                      (busca e resgate em ambientes de selva e montanhas).
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
                ...
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-500">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <motion.div
                      ...
                      className="flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-all duration-200"
                    >
                      <RiRoadMapLine className="h-5 w-5 text-navy-600" />
                      <div>
                        <p className="font-semibold text-gray-800 text-sm">
                    ...
                    <motion.div
                      ...
                      className="flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-all duration-200"
                    >
                      <RiTreeLine className="h-5 w-5 text-navy-600" />
                      <div>
                        <p className="font-semibold text-gray-800 text-sm">
                          Apoio Ambiental
                        </p>
          ...
          >
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 font-bebas tracking-wide">
                PRECISÃO EM CADA MISSÃO
              </h2>
              <p className="text-lg mb-6 text-blue-100 max-w-2xl mx-auto leading-relaxed">
                Nossa equipe está sempre preparada para atuar em qualquer
                ambiente terrestre. Treinamento constante e equipamentos de
                última geração garantem o sucesso de nossas operações.
              </p>
            </motion.div>
