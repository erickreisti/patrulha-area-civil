...
const estatisticas = [
  {
    numero: "15+",
    label: "Treinamentos Especializados",
    icon: RiMedalLine,
    delay: 0,
  },
  {
          ...
          >
            ...
            >
              <Badge className="mb-4 sm:mb-6 bg-white/20 backdrop-blur-sm border-white/20 text-white hover:bg-white/30 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium">
                <RiTreeLine className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
            ...
            >
              ...
              <span className="font-semibold text-white">Preparo</span>,{" "}
              <span className="font-semibold text-white">técnica</span> e{" "}
              <span className="font-semibold text-white">resiliência</span> em
              cada missão.
            </motion.p>
          </motion.div>
        </div>
                ...
                <Card className="border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-500">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                      ...
                      além de serem condicionados para o deslocamento em áreas
                      de matas fechadas e locais de difícil acesso em ambientes
                      hostis.
                    </p>
                    <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                    ...
                    {capacidades.map((capacidade, index) => (
                      ...
                      >
                        <div className="bg-gradient-to-br from-navy-600 to-blue-600 rounded-lg w-10 h-10 flex items-center justify-center flex-shrink-0">
                          <capacidade.icon className="w-5 h-5 text-white" />
                        </div>
                        <div>
          ...
          >
            ...
            >
              <div className="bg-gradient-to-br from-navy-600 to-blue-700 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-lg">
                <RiTreeLine className="w-8 h-8 text-white" />
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 font-bebas tracking-wide">
                ESPECIALISTAS EM AMBIENTES HOSTIS
              </h2>
              <p className="text-lg mb-6 text-blue-100 max-w-2xl mx-auto leading-relaxed">
                Nossa equipe é treinada para atuar nas condições mais adversas.
                Preparo, técnica e determinação são nossas marcas registradas em
                cada operação ambiental.
              </p>
            </motion.div>
