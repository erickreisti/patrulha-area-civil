...
const ActivityCard = ({
  ...
  return (
    <motion.div
      className="text-center p-4 sm:p-6 lg:p-8 bg-white border border-slate-200 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105"
      initial={{ opacity: 0, y: 30 }}
      whileInView={{ opacity: 1, y: 0 }}
    ...
    >
      <div className="flex justify-center mb-3 sm:mb-4">
        <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-navy rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
...
const StatsSection = () => (
  ...
  >
    <div className="bg-white border border-slate-200 rounded-xl p-4 sm:p-6 lg:p-8 shadow-lg">
      ...
      <div className={cn("grid gap-3 sm:gap-4", "grid-cols-2 md:grid-cols-4")}>
